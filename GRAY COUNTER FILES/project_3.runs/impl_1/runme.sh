...
HD_PWD='/home/inf2015/dchristodoulou/CE435/LAB3/Part3_new/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab2_block_wrapper.tcl -notrace
