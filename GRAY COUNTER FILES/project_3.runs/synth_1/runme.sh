...
HD_PWD='/home/inf2015/dchristodoulou/CE435/LAB3/Part3_new/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab2_block_wrapper.tcl
